  ...
  <el-card class="download-container" :class="{'in-chat-mode': inChatMode}">
    ...
    <el-form :model="downloadForm" label-width="75px">
      ...
      <el-form-item label="时间范围" v-if="showTimeRange">
        <el-row :gutter="20">
          <el-col :span="11">
            <el-input v-model="downloadForm.startTime" 
          ...
          <el-col :span="11">
            <el-input v-model="downloadForm.endTime" 
...
const handleDownload = async () => {
  ...
  if(!timeRegex.test(downloadForm.startTime) || !timeRegex.test(downloadForm.endTime)){
